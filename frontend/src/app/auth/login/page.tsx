      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg border p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="/auth/forgot-password" className="text-sm text-blue-600 hover:text-blue-500 font-medium">
              Forgot password?
            </a>
          </div>
          ...
          {error && (
            <div className="text-red-600 text-sm text-center bg-red-50 border border-red-200 rounded-lg p-3 flex items-start">
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button 
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 font-medium text-gray-700 flex items-center justify-center transition-colors"
            >
            ...
            <button 
              type="button"
              onClick={() => alert('LinkedIn login integration coming soon!')}
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 font-medium text-gray-700 flex items-center justify-center transition-colors"
            >
